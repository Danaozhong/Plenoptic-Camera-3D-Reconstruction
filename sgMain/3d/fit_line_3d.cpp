...
namespace sgMain
{
	...
	{
		int CreateNearestNeighborHistogram(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr &depthCloud, const pcl::PointXYZRGB &centerPoint, const std::vector<double> &radii, string fileName)
		{

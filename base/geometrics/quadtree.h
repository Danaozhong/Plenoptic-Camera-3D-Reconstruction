...
#include "base/misc/math_statistics.h"
...
namespace sgBase
{
	...
	public:
		...
		QuadtreeLeafNode() 
			: QuadtreeNode()
		{
			this->container_ = typename pcl::PointCloud<ContainerT>::Ptr(new pcl::PointCloud<ContainerT>);
		}
	...
	public:
		...
		typedef std::shared_ptr<pcl::PointCloud<PointT>> PointCloudConstPtr;
	...
	protected:
		...
		{
			typename pcl::PointCloud<PointT>::Ptr dataContainer = currentNode->getContainerPtr();
			...
			typename pcl::PointCloud<PointT>::Ptr nodeBottomLeftDataContainer = childNodes[0]->getContainerPtr();
			typename pcl::PointCloud<PointT>::Ptr nodeBottomRightDataContainer = childNodes[1]->getContainerPtr();
			typename pcl::PointCloud<PointT>::Ptr nodeUpperLeftDataContainer = childNodes[2]->getContainerPtr();
			typename pcl::PointCloud<PointT>::Ptr nodeUpperRightDataContainer = childNodes[3]->getContainerPtr();

...
namespace sgMain
{
	...
	{
		for (size_t i = 0; i < this->contourLines.size() - 1; i++)
		{
	...
	{
		for (size_t i = 0; i != this->contourLines.size(); i++)
		{
	...
	std::ostream& operator<< (std::ostream& stream, const Contour3D &contour3D)
	{
		...
		for (size_t i = 0; i != contour3D.contourLines.size(); i++)
		{
